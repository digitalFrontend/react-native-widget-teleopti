...
public class ScheduleSecondDataObjectDBRepository {

  private String DB_NAME = "db_schedule_second_data_objects";

  private ScheduleDataObjectDBDatabase scheduleDataObjectDBDatabase;
  public ScheduleSecondDataObjectDBRepository(Context context) {
